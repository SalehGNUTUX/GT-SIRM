...
function _appVersion() {
  // ⚠️ v1.5.0 — الجِسرُ الأَصليُّ لَيسَ مَعصوماً: `versionName` في أندرويد ظَلَّ
  //   "1.0" (افتِراضُ Capacitor) حَتّى v1.5.0، فَكانَ «المَصدَرُ الذي لا يَكذِب»
...
async function openProjectInteractive() {
  ...
  // ⚠️ v1.5.0 — أندرويد يُصَفّي المُنتَقيَ بِحَسَبِ `accept`، و`.gtsirm` لاحِقةٌ
