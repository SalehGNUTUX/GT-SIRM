// GT-SIRM Service Worker v54 — إصدار v0.12.11 (إعدادات قابلة للطيّ <details> + إعادة تَرتيب + قَوالب بتَراجع وَتَعديل)
// يجب رفع رقم الإصدار عند كل تحديث للملفات
const CACHE_VER = "gt-sirm-v54";
